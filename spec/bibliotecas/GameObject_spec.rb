...
describe 'GameObject' do
  ...
  describe '.isEqual' do
    it "Verifica se um GameObject \xC3\xA9 igual a outro" do
      game_object = GameObject.new
      expect(game_object.isEqual(game_object)).to be_truthy
    end

    it "Verifica se um GameObject \xC3\xA9 diferemte do outro" do
      game_object = GameObject.new
  ...
  describe '.notity_colision' do
    it "Verifica se houve colis\xC3\xA3o entre dois GameObjects" do
      game_object = GameObject.new
    ...
    it "Verifica se n\xC3\xA3o houve colis\xC3\xA3o entre dois GameObjects" do
      game_object = GameObject.new
      game_object.box.h = 10
      game_object.box.w = 10
